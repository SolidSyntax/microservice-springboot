...
@RefreshScope
@Service
public class RefreshingBatch implements ApplicationListener<RefreshScopeRefreshedEvent> {
    private static final Logger LOGGER = LoggerFactory.getLogger(RefreshingBatch.class);
